...
export class Console {
  ...
  drawDoubleBox(
    ...
    this.drawVLine(x, y, height, Chars.BOX_DOUBLE_VERTICAL, fg, bg);
    this.drawVLine(x + width - 1, y, height, Chars.BOX_DOUBLE_VERTICAL, fg, bg);

    this.drawChar(x, y, Chars.BOX_DOUBLE_DOWN_AND_DOUBLE_RIGHT, fg, bg);
    this.drawChar(
        x + width - 1, y, Chars.BOX_DOUBLE_DOWN_AND_DOUBLE_LEFT, fg, bg);
    this.drawChar(
        x, y + height - 1, Chars.BOX_DOUBLE_UP_AND_DOUBLE_RIGHT, fg, bg);
    this.drawChar(
        x + width - 1, y + height - 1, Chars.BOX_DOUBLE_UP_AND_DOUBLE_LEFT, fg,
        bg);
  }
