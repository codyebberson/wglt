 ...
 */
declare function fromRgb(r: number, g: number, b: number, a?: number): Color;
/**
 ...
 * @return A 32-bit unsigned integer color.
 */
declare function fromHsv(h: number, s: number, v: number, a?: number): Color;
...
declare function fixBoxCells(con: Console): void;
...
declare const DEFAULT_FONT: Font;
...
declare function getFovQuadrant(dx: number, dy: number): FovQuadrants;
...
declare class Terminal extends Console {
...
declare class DefaultDialogRenderer {
    getState(terminal: Terminal, dialog: Dialog): DialogState;
    draw(term: Terminal, dialogState: DialogState): void;
}
...
declare class SelectDialog extends Dialog {
...
declare function loadImage(url: string, callback: (img: Console) => void): void;
declare function loadImage2x(url: string, callback: (img: Console) => void): void;
 ...
 */
declare function computePath(map: Console, source: Point, dest: Point, maxDist: number): Cell[] | undefined;
...
export { BlendMode, Cell, Chars, Color, Colors, Console, DEFAULT_FONT, DefaultDialogRenderer, Dialog, DialogState, Font, FovOctants, FovQuadrants, GUI, Keyboard, Keys, MessageDialog, Mouse, Point, RNG, Rect, SelectDialog, Terminal, computePath, fixBoxCells, fromHsv, fromRgb, getFovQuadrant, loadImage, loadImage2x };
