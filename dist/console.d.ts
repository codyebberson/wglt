...
export declare class Console {
    ...
    drawChar(x: number, y: number, c: number, fg?: Color, bg?: Color): void;
    ...
    drawHLine(x: number, y: number, width: number, c: number, fg?: Color, bg?: Color): void;
    drawVLine(x: number, y: number, height: number, c: number, fg?: Color, bg?: Color): void;
