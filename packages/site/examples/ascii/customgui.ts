...
import { CgaPalette, Key, Point, Rect } from '@wglt/core';
...
class CustomRenderer implements DialogRenderer {
  ...
  draw(terminal: Terminal, dialogState: DialogState): void {
    ...
    buffer.fillRect(0, 0, width, height, 0, CgaPalette.LIGHT_CYAN, CgaPalette.DARK_CYAN);
...
term.update = () => {
  ...
  term.clear();
  term.fillRect(0, 0, 80, 45, 0, CgaPalette.LIGHT_GREEN, CgaPalette.BLACK);
