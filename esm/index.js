...
class ScrollableMessageDialog extends Dialog {
    ...
    drawContents(console, offset) {
        ...
        console.drawVLine(this.contentsRect.x + this.contentsRect.width + 1, this.contentsRect.y + scrollbarY, this.scrollbarHeight, Chars.MEDIUM_SHADE);
    }
    handleInput(terminal) {
...
export { BlendMode, Cell, Chars, ColodorePalette, Colors, Commodore64Palette, Console, DEFAULT_FONT, DefaultDialogRenderer, Dialog, DialogState, Font, FovOctants, FovQuadrants, GUI, Key, Keyboard, Message, MessageDialog, Mouse, Pico8Palette, Point, RNG, Rect, ScrollableMessageDialog, SelectDialog, Terminal, capitalize, computePath, deserialize, fixBoxCells, fromHsv, fromRgb, getFovQuadrant, loadImage, loadImage2x, serializable, serialize, wordWrap };
