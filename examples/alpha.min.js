...
/******/ 	return __webpack_require__(__webpack_require__.s = "./examples/alpha.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _src_blendmode_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../src/blendmode.js */ \"./src/blendmode.js\");\n/* harmony import */ var _src_colors_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../src/colors.js */ \"./src/colors.js\");\n/* harmony import */ var _src_console_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../src/console.js */ \"./src/console.js\");\n/* harmony import */ var _src_color_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../src/color.js */ \"./src/color.js\");\n/* harmony import */ var _src_keys_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../src/keys.js */ \"./src/keys.js\");\n/* harmony import */ var _src_rng_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../src/rng.js */ \"./src/rng.js\");\n/* harmony import */ var _src_terminal_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../src/terminal.js */ \"./src/terminal.js\");\n\n\n\n\n\n\n\n\n\nconst SCREEN_WIDTH = 80;\nconst SCREEN_HEIGHT = 45;\n\nconst RADIUS = 30;\nconst SIZE = 1 + 2 * RADIUS;\nconst CENTER = RADIUS;\nconst BRIGHTNESS = 0.35;\n\nfunction createLightConsole(h, s, v) {\n    const c = new _src_console_js__WEBPACK_IMPORTED_MODULE_2__[\"Console\"](SIZE, SIZE);\n\n    for (let y = 0; y < SIZE; y++) {\n        for (let x = 0; x < SIZE; x++) {\n            const distance = Math.hypot(x - CENTER, y - CENTER);\n            const inverseDistance = Math.max(0.0, Math.min(1.0, 1.0 - distance / RADIUS));\n            const alpha = BRIGHTNESS * inverseDistance * inverseDistance;\n            const bg = Object(_src_color_js__WEBPACK_IMPORTED_MODULE_3__[\"fromHsv\"])(h, s, v, alpha);\n            c.drawChar(x, y, 0, 0, bg);\n        }\n    }\n\n    c.drawChar(CENTER, CENTER, '*'.charCodeAt(0), Object(_src_color_js__WEBPACK_IMPORTED_MODULE_3__[\"fromHsv\"])(h, s, v));\n    return c;\n}\n\nconst term = new _src_terminal_js__WEBPACK_IMPORTED_MODULE_6__[\"Terminal\"](\n    document.querySelector('canvas'),\n    SCREEN_WIDTH,\n    SCREEN_HEIGHT,\n    { requestFullscreen: true });\n\nconst rng = new _src_rng_js__WEBPACK_IMPORTED_MODULE_5__[\"RNG\"]();\n\nconst lights = [{\n    x: 10,\n    y: 10,\n    console: createLightConsole(0.0, 0.0, 1.0)\n}];\n\nfor (let i = 0; i < 6; i++) {\n    lights.push({\n        x: 15 + i * 10,\n        y: 22,\n        console: createLightConsole(i / 6.0, 1.0, 1.0)\n    });\n}\n\nconst rain = [];\n\nfor (let i = 0; i < 500; i++) {\n    rain.push({\n        x: rng.nextRange(0, SCREEN_WIDTH * 2),\n        y: rng.nextRange(-SCREEN_HEIGHT, SCREEN_HEIGHT),\n        speed: rng.nextRange(5, 10) / 5.0\n    });\n}\n\nterm.update = function () {\n    if (term.isKeyPressed(_src_keys_js__WEBPACK_IMPORTED_MODULE_4__[\"Keys\"].VK_UP)) {\n        lights[0].y--;\n    }\n    if (term.isKeyPressed(_src_keys_js__WEBPACK_IMPORTED_MODULE_4__[\"Keys\"].VK_LEFT)) {\n        lights[0].x--;\n    }\n    if (term.isKeyPressed(_src_keys_js__WEBPACK_IMPORTED_MODULE_4__[\"Keys\"].VK_RIGHT)) {\n        lights[0].x++;\n    }\n    if (term.isKeyPressed(_src_keys_js__WEBPACK_IMPORTED_MODULE_4__[\"Keys\"].VK_DOWN)) {\n        lights[0].y++;\n    }\n    if (term.mouse.dx !== 0 || term.mouse.dy !== 0) {\n        lights[0].x = term.mouse.x;\n        lights[0].y = term.mouse.y;\n    }\n\n    term.fillRect(0, 0, 80, 50, 0, _src_colors_js__WEBPACK_IMPORTED_MODULE_1__[\"Colors\"].BLACK, _src_colors_js__WEBPACK_IMPORTED_MODULE_1__[\"Colors\"].BLACK);\n\n    for (let i = 0; i < rain.length; i++) {\n        const raindrop = rain[i];\n        term.drawString(Math.round(raindrop.x), Math.round(raindrop.y), '/', _src_colors_js__WEBPACK_IMPORTED_MODULE_1__[\"Colors\"].DARK_GRAY);\n        raindrop.x -= raindrop.speed;\n        raindrop.y += raindrop.speed;\n        if (raindrop.x < 0 || raindrop.y > SCREEN_HEIGHT) {\n            raindrop.x += SCREEN_WIDTH;\n            raindrop.y -= SCREEN_WIDTH;\n        }\n    }\n\n    for (let i = lights.length - 1; i >= 0; i--) {\n        const light = lights[i];\n        term.drawConsole(\n            light.x - RADIUS,\n            light.y - RADIUS,\n            light.console,\n            0,\n            0,\n            SIZE,\n            SIZE,\n            _src_blendmode_js__WEBPACK_IMPORTED_MODULE_0__[\"BlendMode\"].Add);\n    }\n\n    term.drawString(1, 1, 'Hello world!', _src_colors_js__WEBPACK_IMPORTED_MODULE_1__[\"Colors\"].YELLOW);\n    term.drawString(1, 3, 'Use arrow keys to move', _src_colors_js__WEBPACK_IMPORTED_MODULE_1__[\"Colors\"].YELLOW);\n};\n\n\n//# sourceURL=webpack:///./examples/alpha.js?");
