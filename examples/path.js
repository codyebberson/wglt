...
const fov = new wglt.FovMap(SCREEN_WIDTH, SCREEN_HEIGHT, isBlocked);
...
term.update = function () {
    ...
    term.clear();
    game.fillRect(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, 0, 0, wglt.Colors.BLACK);
    ...
    const path = wglt.computePath(fov, player, term.mouse, 1000);
    if (path) {
