...
/******/ 	return __webpack_require__(__webpack_require__.s = "./examples/mock.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _src_boxutils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../src/boxutils.js */ \"./src/boxutils.js\");\n/* harmony import */ var _src_colors_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../src/colors.js */ \"./src/colors.js\");\n/* harmony import */ var _src_console_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../src/console.js */ \"./src/console.js\");\n/* harmony import */ var _src_terminal_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../src/terminal.js */ \"./src/terminal.js\");\n/* harmony import */ var _src_chars_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../src/chars.js */ \"./src/chars.js\");\n/* harmony import */ var _src_keys_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../src/keys.js */ \"./src/keys.js\");\n\n\n\n\n\n\n\n\nconst SCREEN_WIDTH = 80;\nconst SCREEN_HEIGHT = 45;\n\nconst term = new _src_terminal_js__WEBPACK_IMPORTED_MODULE_3__[\"Terminal\"](document.querySelector('canvas'), SCREEN_WIDTH, SCREEN_HEIGHT);\n\nconst game = new _src_console_js__WEBPACK_IMPORTED_MODULE_2__[\"Console\"](SCREEN_WIDTH, SCREEN_HEIGHT);\n\n// Starcraft\n// game.drawDoubleBox(0, 30, 15, 15, Colors.LIGHT_GREEN, Colors.DARK_GREEN);\n// game.drawDoubleBox(15, 35, 50, 10, Colors.LIGHT_GREEN, Colors.DARK_GREEN);\n// game.drawDoubleBox(65, 30, 15, 15, Colors.LIGHT_GREEN, Colors.DARK_GREEN);\n\ngame.drawDoubleBox(0, 0, 16, 45, _src_colors_js__WEBPACK_IMPORTED_MODULE_1__[\"Colors\"].LIGHT_GREEN, _src_colors_js__WEBPACK_IMPORTED_MODULE_1__[\"Colors\"].DARK_GREEN);\ngame.drawDoubleBox(0, 40, 80, 5, _src_colors_js__WEBPACK_IMPORTED_MODULE_1__[\"Colors\"].LIGHT_GREEN, _src_colors_js__WEBPACK_IMPORTED_MODULE_1__[\"Colors\"].DARK_GREEN);\ngame.drawDoubleBox(65, 0, 15, 15, _src_colors_js__WEBPACK_IMPORTED_MODULE_1__[\"Colors\"].LIGHT_GREEN, _src_colors_js__WEBPACK_IMPORTED_MODULE_1__[\"Colors\"].DARK_GREEN);\nfor (let x = 5; x < SCREEN_WIDTH; x += 5) {\n    game.drawVLine(x, 40, 5, _src_chars_js__WEBPACK_IMPORTED_MODULE_4__[\"Chars\"].BOX_SINGLE_VERTICAL, _src_colors_js__WEBPACK_IMPORTED_MODULE_1__[\"Colors\"].LIGHT_GREEN, _src_colors_js__WEBPACK_IMPORTED_MODULE_1__[\"Colors\"].DARK_GREEN);\n}\n\n// This will update all box cells in the console such that stems match\nObject(_src_boxutils_js__WEBPACK_IMPORTED_MODULE_0__[\"fixBoxCells\"])(game);\n\nconst player = {\n    x: 10,\n    y: 10,\n    dx: 0,\n    dy: 0,\n    shootDx: 1,\n    shootDy: 0\n};\n\nconst bullets = [];\n\nlet t = 0;\nlet shootReleased = true;\n\nterm.update = function () {\n    t++;\n    if (t === 5) {\n        if (term.isKeyDown(_src_keys_js__WEBPACK_IMPORTED_MODULE_5__[\"Keys\"].VK_X)) {\n            if (shootReleased) {\n                bullets.push({\n                    x: player.x,\n                    y: player.y,\n                    dx: 4 * player.shootDx,\n                    dy: 4 * player.shootDy,\n                    life: 30\n                });\n                shootReleased = false;\n            }\n        } else {\n            shootReleased = true;\n            if (term.isKeyDown(_src_keys_js__WEBPACK_IMPORTED_MODULE_5__[\"Keys\"].VK_UP)) {\n                player.y--;\n                player.dy = -1;\n            } else if (term.isKeyDown(_src_keys_js__WEBPACK_IMPORTED_MODULE_5__[\"Keys\"].VK_DOWN)) {\n                player.y++;\n                player.dy = 1;\n            } else {\n                player.dy = 0;\n            }\n            if (term.isKeyDown(_src_keys_js__WEBPACK_IMPORTED_MODULE_5__[\"Keys\"].VK_LEFT)) {\n                player.x--;\n                player.dx = -1;\n            } else if (term.isKeyDown(_src_keys_js__WEBPACK_IMPORTED_MODULE_5__[\"Keys\"].VK_RIGHT)) {\n                player.x++;\n                player.dx = 1;\n            } else {\n                player.dx = 0;\n            }\n        }\n        if (player.dx !== 0 || player.dy !== 0) {\n            player.shootDx = player.dx;\n            player.shootDy = player.dy;\n        }\n        for (let i = bullets.length - 1; i >= 0; i--) {\n            const bullet = bullets[i];\n            bullet.x += bullet.dx;\n            bullet.y += bullet.dy;\n            bullet.life--;\n            if (bullet.life < 0) {\n                bullets.splice(i, 1);\n            }\n        }\n\n        term.clear();\n\n        for (let y = 0; y < 40; y++) {\n            for (let x = 16; x < 80; x++) {\n                if (Math.random() < 0.05) {\n                    term.drawChar(x, y, '/', _src_colors_js__WEBPACK_IMPORTED_MODULE_1__[\"Colors\"].DARK_GRAY);\n                }\n            }\n        }\n\n        term.drawString(player.x, player.y, '@', _src_colors_js__WEBPACK_IMPORTED_MODULE_1__[\"Colors\"].WHITE);\n\n        for (let i = 0; i < bullets.length; i++) {\n            const bullet = bullets[i];\n            term.drawChar(bullet.x, bullet.y, _src_chars_js__WEBPACK_IMPORTED_MODULE_4__[\"Chars\"].BULLET, _src_colors_js__WEBPACK_IMPORTED_MODULE_1__[\"Colors\"].WHITE);\n        }\n\n        term.drawConsole(0, 0, game, 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT);\n        term.drawString(1, 1, 'Hello world!', _src_colors_js__WEBPACK_IMPORTED_MODULE_1__[\"Colors\"].LIGHT_GREEN);\n        t = 0;\n    }\n};\n\n\n//# sourceURL=webpack:///./examples/mock.js?");
