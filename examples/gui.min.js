...
/******/ 	return __webpack_require__(__webpack_require__.s = "./examples/gui.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _src_colors_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../src/colors.js */ \"./src/colors.js\");\n/* harmony import */ var _src_gui_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../src/gui.js */ \"./src/gui.js\");\n/* harmony import */ var _src_gui_messagedialog_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../src/gui/messagedialog.js */ \"./src/gui/messagedialog.js\");\n/* harmony import */ var _src_gui_selectdialog_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../src/gui/selectdialog.js */ \"./src/gui/selectdialog.js\");\n/* harmony import */ var _src_keys_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../src/keys.js */ \"./src/keys.js\");\n/* harmony import */ var _src_terminal_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../src/terminal.js */ \"./src/terminal.js\");\n\n\n\n\n\n\n\n\nconst term = new _src_terminal_js__WEBPACK_IMPORTED_MODULE_5__[\"Terminal\"](document.querySelector('canvas'), 80, 50);\n\nconst gui = new _src_gui_js__WEBPACK_IMPORTED_MODULE_1__[\"GUI\"](term);\n\nconst options = [\n    'Sword',\n    'Banana',\n    'Magic Potion',\n    'Red Stapler'\n];\n\nlet x = 10;\nlet y = 10;\n\nterm.update = function () {\n    if (!gui.handleInput(term)) {\n        if (term.isKeyDown(_src_keys_js__WEBPACK_IMPORTED_MODULE_4__[\"Keys\"].VK_UP)) {\n            y--;\n        }\n        if (term.isKeyDown(_src_keys_js__WEBPACK_IMPORTED_MODULE_4__[\"Keys\"].VK_LEFT)) {\n            x--;\n        }\n        if (term.isKeyDown(_src_keys_js__WEBPACK_IMPORTED_MODULE_4__[\"Keys\"].VK_RIGHT)) {\n            x++;\n        }\n        if (term.isKeyDown(_src_keys_js__WEBPACK_IMPORTED_MODULE_4__[\"Keys\"].VK_DOWN)) {\n            y++;\n        }\n        if (term.isKeyPressed(_src_keys_js__WEBPACK_IMPORTED_MODULE_4__[\"Keys\"].VK_H)) {\n            gui.add(new _src_gui_messagedialog_js__WEBPACK_IMPORTED_MODULE_2__[\"MessageDialog\"]('ALERT', 'Hello World'));\n        }\n        if (term.isKeyPressed(_src_keys_js__WEBPACK_IMPORTED_MODULE_4__[\"Keys\"].VK_I)) {\n            gui.add(new _src_gui_selectdialog_js__WEBPACK_IMPORTED_MODULE_3__[\"SelectDialog\"]('INVENTORY', options, (choice) => {\n                gui.add(new _src_gui_messagedialog_js__WEBPACK_IMPORTED_MODULE_2__[\"MessageDialog\"]('ALERT', 'You chose: ' + options[choice]));\n            }));\n        }\n    }\n\n    term.clear();\n    term.fillRect(0, 0, 80, 50, 0, _src_colors_js__WEBPACK_IMPORTED_MODULE_0__[\"Colors\"].YELLOW, _src_colors_js__WEBPACK_IMPORTED_MODULE_0__[\"Colors\"].DARK_BLUE);\n    term.drawString(1, 1, 'Hello world!');\n    term.drawString(1, 3, 'Use arrow keys to move');\n    term.drawString(1, 5, 'Press \"h\" to open a MessageDialog');\n    term.drawString(1, 7, 'Press \"i\" to open a SelectDialog');\n    term.drawString(x, y, '@');\n    gui.draw();\n};\n\n\n//# sourceURL=webpack:///./examples/gui.js?");
