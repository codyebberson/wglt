...
function newGame() {
    ...
    player = new Entity(40, 25, '@', 'player', colors_1.Colors.WHITE, true, { fighter: new Fighter(20, 2, 5, 0, playerDeath) });
    player.level = 1;
    entities = [player];
    messages = [];
    dungeonLevel = 1;
